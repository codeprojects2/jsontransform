...
public class JsltTestCLass extends TestBase {
    @Test
    ...
    @Test
    public void testProduceEmptyObjectML() {
        String query =
                "{\n" +
                "  \"eventId\" : .eventId,\n" +	
    ...
    public void testDevice() {
        String query =
                "{\n" +
                "  \"osType\" : .device.osType + \" \" + .device.model \n" +
                "}\n";
        String input =  "{\n" +
                "  \"eventId\" : \"878237843\",\n" +
                "  \"device\" : {\n" +
    ...
    public static void main(String[] args) {
    	JsltTestCLass t = new JsltTestCLass();
    	t.testProduceEmptyObjectML();
